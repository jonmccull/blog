...
date: '2025-06-04'
excerpt: 'Marketers love a good framework. But there's really only one you need. GACC.'
---
...
Writing a newsletter? GACC it. Building a paid campaign? GACC. Moving upmarket and kicking off a new growth motion? GACC.

Give it a try on your next project and see where it takes you.

![A campaign brief using GACC](/images-blog/GACC-in-action.webp 'A screenshot of a Google Doc with a table of text outlining the Goals and Audience for a marketing campaign')

_All credit to MKT1 for introducing me to [GACC](https://newsletter.mkt1.co/p/the-gacc-marketing-brief-the-best). If you’re a curious marketer navigating B2B SaaS, [subscribe to their newsletter here](https://newsletter.mkt1.co)._
