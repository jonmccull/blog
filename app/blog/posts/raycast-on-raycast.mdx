...
Just to be clear, *this* is me writing. This is Jon. But *below* is a review of Raycast, written entirely by Raycast AI (using [Claude 3 Sonnet](https://www.anthropic.com/news/claude-3-family) by [Anthropic](https://www.anthropic.com/) in this case). It's not the initial output, but not very far from it. I spent all of 10 minutes iterating and tweaking using a set of instructions I'd quickly grabbed for a "Pro Writer" GPT and giving the usual nudges to sculpt the content (i.e. "**don't** say *in a fast-paced digital world*" 🙃).
