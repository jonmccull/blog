export default function Page() {
  return (
    <section>
      ...
      <p className="job-dates mb-4">JAN 2024 → PRESENT</p>
        
      <p className="job-description mb-4">Doist is a fully remote software company that empowers people with simple yet powerful tools. I joined in January 2024 to lead on Go-to-Market efforts for updates to their flagship product, <a href="https://todoist.com/">Todoist</a>.</p>
      ...
      <p className="job-description mb-4">As the lead on Product Marketing I tackled branding, positioning, user acquisition and activation. I worked at the intersection of product development, marketing, PR, and community, with a view of gaining growth in the millions of users globally.</p>
        ...
        - DRI on flagship launches including [Vivaldi Android](https://play.google.com/store/apps/details?id=com.vivaldi.browser&hl=en&gl=US&pli=1), [Android Automotive](https://vivaldi.com/android/automotive/) and [Mail (beta)](https://vivaldi.com/features/mail/)
      ...
      <p className="job-description mb-4">I joined Vivaldi as Manager on a small marketing team of four. Areas of responsibility varied widely, but focused primarily on user acquisition, onboarding/ activation, establishing departmental strategy/workflow, KPIs and dashboards, and cross-channel content creation in support of product launches.</p>
        ...
        - Consistent top tier PR coverage (e.g. [Verge](https://www.theverge.com/2019/9/9/20853651/vivaldi-browser-android-mobile-beta-sync-chrome-firefox-opera), [TechCrunch](https://techcrunch.com/tag/vivaldi/), [Wired](https://www.wired.com/story/try-vivaldi-browser-android-chrome/))
